...
<body>
    ...
    <div class="side">
        <div class="sideMenu" style="margin:0 auto">
          <h3>个人信息</h3>
          <ul>
            <li><a href="stuInfo" target="right">学籍信息</a></li>
          </ul>
          <h3>成绩信息</h3>
          <ul>
            <li><a href="scoreInfo" target="right">成绩查询</a></li>
          </ul>
          <h3>课程信息</h3>
          <ul>
            <li><a href="selectCurriculum" target="right">课程查询</a></li>
            <li><a href="chooseCourse" target="right">选课系统</a></li>
          </ul>
       </div>
    </div>
    <div class="main">
